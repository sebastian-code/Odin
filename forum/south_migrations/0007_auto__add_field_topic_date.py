...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'forum_topic', 'date',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, default=datetime.datetime(2014, 5, 18, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topic.date'
        db.delete_column(u'forum_topic', 'date')
