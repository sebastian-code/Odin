...
urlpatterns = patterns('forum.views',
    ...
    url(r'^forum/add_topic/(?P<category_id>[0-9]+)/$', 'add_topic', name='add_topic'),
    url(r'^forum/edit_topic/(?P<topic_id>[0-9]+)/$', 'edit_topic', name='edit_topic'),
    url(r'^forum/edit_comment/(?P<comment_id>[0-9]+)/$', 'edit_comment', name='edit_comment'),
