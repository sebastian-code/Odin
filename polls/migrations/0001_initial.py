...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'polls_question', (
            ...
            ('free_text_enabled', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        # Adding M2M table for field question on 'Poll'
        m2m_table_name = db.shorten_name(u'polls_poll_question')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('poll', models.ForeignKey(orm[u'polls.poll'], null=False)),
            ('question', models.ForeignKey(orm[u'polls.question'], null=False))
        ))
        db.create_unique(m2m_table_name, ['poll_id', 'question_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field question on 'Poll'
        db.delete_table(db.shorten_name(u'polls_poll_question'))
    ...
    models = {
        ...
        u'polls.poll': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'question': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['polls.Question']", 'symmetrical': 'False'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '256'})
        },
        u'polls.question': {
            'Meta': {'object_name': 'Question'},
            'free_text_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
