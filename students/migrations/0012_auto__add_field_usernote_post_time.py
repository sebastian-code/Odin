...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserNote.post_time'
        db.add_column(u'students_usernote', 'post_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 5, 3, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserNote.post_time'
        db.delete_column(u'students_usernote', 'post_time')
