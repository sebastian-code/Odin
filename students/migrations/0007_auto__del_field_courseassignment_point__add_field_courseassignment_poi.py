...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CourseAssignment.point'
        db.delete_column(u'students_courseassignment', 'point')

        # Adding field 'CourseAssignment.points'
        db.add_column(u'students_courseassignment', 'points',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default='0'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CourseAssignment.point'
        db.add_column(u'students_courseassignment', 'point',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default='0'),
                      keep_default=False)

        # Deleting field 'CourseAssignment.points'
        db.delete_column(u'students_courseassignment', 'points')
