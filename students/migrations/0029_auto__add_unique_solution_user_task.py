...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Solution', fields ['user', 'task']
        db.create_unique(u'students_solution', ['user_id', 'task_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Solution', fields ['user', 'task']
        db.delete_unique(u'students_solution', ['user_id', 'task_id'])
