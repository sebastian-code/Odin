    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(default=1, choices=[(1, b'Student'), (2, b'HR'), (3, b'Teacher')])),
                ('avatar', django_resized.forms.ResizedImageField(upload_to=b'avatar', blank=True)),
                ...
                ('works_at', models.CharField(max_length=b'40', null=True, blank=True)),
            ],
            options={
                'abstract': False,
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('cv', models.FileField(null=True, upload_to=b'cvs', blank=True)),
                ('group_time', models.SmallIntegerField(choices=[(1, b'Early'), (2, b'Late')])),
