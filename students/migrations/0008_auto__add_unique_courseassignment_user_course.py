...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CourseAssignment', fields ['user', 'course']
        db.create_unique(u'students_courseassignment', ['user_id', 'course_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CourseAssignment', fields ['user', 'course']
        db.delete_unique(u'students_courseassignment', ['user_id', 'course_id'])
