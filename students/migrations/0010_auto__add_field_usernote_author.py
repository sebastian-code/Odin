...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserNote.author'
        db.add_column(u'students_usernote', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['students.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserNote.author'
        db.delete_column(u'students_usernote', 'author_id')
