...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'User.faculty_number'
        db.delete_column(u'students_user', 'faculty_number')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'User.faculty_number'
        raise RuntimeError("Cannot reverse this migration. 'User.faculty_number' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'User.faculty_number'
        db.add_column(u'students_user', 'faculty_number',
