...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'User.receive_emails'
        db.delete_column(u'students_user', 'receive_emails')

        # Adding M2M table for field subscribed_topics on 'User'
        m2m_table_name = db.shorten_name(u'students_user_subscribed_topics')
        ...
        db.create_unique(m2m_table_name, ['user_id', 'topic_id'])


    def backwards(self, orm):
        # Adding field 'User.receive_emails'
        db.add_column(u'students_user', 'receive_emails',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Removing M2M table for field subscribed_topics on 'User'
        db.delete_table(db.shorten_name(u'students_user_subscribed_topics'))
