...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'students_solution', (
            ...
            ('repo', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal(u'students', ['Solution'])


    def backwards(self, orm):
        # Deleting model 'Solution'
        db.delete_table(u'students_solution')
