...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.mac'
        db.add_column(u'students_user', 'mac',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=17),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.mac'
        db.delete_column(u'students_user', 'mac')
