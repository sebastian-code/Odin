...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field favourite_partners on 'CourseAssignment'
        m2m_table_name = db.shorten_name(u'students_courseassignment_favourite_partners')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('courseassignment', models.ForeignKey(orm[u'students.courseassignment'], null=False)),
            ('partner', models.ForeignKey(orm[u'courses.partner'], null=False))
        ))
        db.create_unique(m2m_table_name, ['courseassignment_id', 'partner_id'])


    def backwards(self, orm):
        # Removing M2M table for field favourite_partners on 'CourseAssignment'
        db.delete_table(db.shorten_name(u'students_courseassignment_favourite_partners'))
