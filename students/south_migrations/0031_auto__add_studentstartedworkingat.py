...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StudentStartedWorkingAt'
        db.create_table(u'students_studentstartedworkingat', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('assignment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['students.CourseAssignment'])),
            ('partner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.Partner'], null=True, blank=True)),
            ('partner_name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
        ))
        db.send_create_signal(u'students', ['StudentStartedWorkingAt'])


    def backwards(self, orm):
        # Deleting model 'StudentStartedWorkingAt'
        db.delete_table(u'students_studentstartedworkingat')
    ...
    models = {
        ...
        u'students.studentstartedworkingat': {
            'Meta': {'object_name': 'StudentStartedWorkingAt'},
            'assignment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['students.CourseAssignment']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'partner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['courses.Partner']", 'null': 'True', 'blank': 'True'}),
