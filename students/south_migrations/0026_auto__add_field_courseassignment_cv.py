...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseAssignment.cv'
        db.add_column(u'students_courseassignment', 'cv',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseAssignment.cv'
        db.delete_column(u'students_courseassignment', 'cv')
