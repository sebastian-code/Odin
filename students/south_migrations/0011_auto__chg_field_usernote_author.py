...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserNote.author'
        db.alter_column(u'students_usernote', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['students.User'], null=True))

    def backwards(self, orm):

        # Changing field 'UserNote.author'
        db.alter_column(u'students_usernote', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['students.User']))
