...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'courses_certificate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('assignment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['students.CourseAssignment'])),
            ('issues_closed', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('issues_opened', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'courses', ['Certificate'])

        # Adding M2M table for field weekly_commits on 'Certificate'
        m2m_table_name = db.shorten_name(u'courses_certificate_weekly_commits')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('certificate', models.ForeignKey(orm[u'courses.certificate'], null=False)),
            ('weeklycommit', models.ForeignKey(orm[u'courses.weeklycommit'], null=False))
        ))
        db.create_unique(m2m_table_name, ['certificate_id', 'weeklycommit_id'])

        # Adding model 'WeeklyCommit'
        db.create_table(u'courses_weeklycommit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('commits_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'courses', ['WeeklyCommit'])


    def backwards(self, orm):
        # Deleting model 'Certificate'
        db.delete_table(u'courses_certificate')

        # Removing M2M table for field weekly_commits on 'Certificate'
        db.delete_table(db.shorten_name(u'courses_certificate_weekly_commits'))

        # Deleting model 'WeeklyCommit'
        db.delete_table(u'courses_weeklycommit')
    ...
    models = {
        ...
        u'courses.task': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'week': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'})
        },
