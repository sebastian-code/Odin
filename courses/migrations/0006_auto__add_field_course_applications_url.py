...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.applications_url'
        db.add_column(u'courses_course', 'applications_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.applications_url'
        db.delete_column(u'courses_course', 'applications_url')
