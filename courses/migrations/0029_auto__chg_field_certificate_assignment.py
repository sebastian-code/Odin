...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Certificate.assignment'
        db.alter_column(u'courses_certificate', 'assignment_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['students.CourseAssignment'], unique=True))

    def backwards(self, orm):

        # Changing field 'Certificate.assignment'
        db.alter_column(u'courses_certificate', 'assignment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['students.CourseAssignment'], unique=True))
