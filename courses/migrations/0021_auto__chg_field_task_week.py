...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.week'
        db.alter_column(u'courses_task', 'week', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'Task.week'
        db.alter_column(u'courses_task', 'week', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
