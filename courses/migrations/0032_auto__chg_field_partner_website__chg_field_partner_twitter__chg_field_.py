...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Partner.website'
        db.alter_column(u'courses_partner', 'website', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

        # Changing field 'Partner.twitter'
        db.alter_column(u'courses_partner', 'twitter', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

        # Changing field 'Partner.facebook'
        db.alter_column(u'courses_partner', 'facebook', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

        # Changing field 'Partner.logo'
        db.alter_column(u'courses_partner', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'Course.applications_url'
        db.alter_column(u'courses_course', 'applications_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

        # Changing field 'Course.image'
        db.alter_column(u'courses_course', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'Course.next_season_mail_list'
        db.alter_column(u'courses_course', 'next_season_mail_list', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

    def backwards(self, orm):

        # Changing field 'Partner.website'
        db.alter_column(u'courses_partner', 'website', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Partner.twitter'
        db.alter_column(u'courses_partner', 'twitter', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Partner.facebook'
        db.alter_column(u'courses_partner', 'facebook', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Partner.logo'
        db.alter_column(u'courses_partner', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Course.applications_url'
        db.alter_column(u'courses_course', 'applications_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Course.image'
        db.alter_column(u'courses_course', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    models = {
        ...
        u'courses.certificate': {
            ...
            'assignment': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['students.CourseAssignment']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
