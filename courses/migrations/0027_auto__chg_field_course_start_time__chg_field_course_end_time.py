...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'courses_course', 'start_time', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Course.end_time'
        db.alter_column(u'courses_course', 'end_time', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Course.start_time'
        raise RuntimeError("Cannot reverse this migration. 'Course.start_time' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Course.start_time'
        db.alter_column(u'courses_course', 'start_time', self.gf('django.db.models.fields.DateField')())

        # User chose to not deal with backwards NULL issues for 'Course.end_time'
        raise RuntimeError("Cannot reverse this migration. 'Course.end_time' and its values cannot be restored.")
