...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Certificate', fields ['assignment']
        db.create_unique(u'courses_certificate', ['assignment_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Certificate', fields ['assignment']
        db.delete_unique(u'courses_certificate', ['assignment_id'])
