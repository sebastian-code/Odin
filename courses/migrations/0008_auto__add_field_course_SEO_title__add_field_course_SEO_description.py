...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.SEO_title'
        db.add_column(u'courses_course', 'SEO_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Course.SEO_description'
        db.add_column(u'courses_course', 'SEO_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.SEO_title'
        db.delete_column(u'courses_course', 'SEO_title')

        # Deleting field 'Course.SEO_description'
        db.delete_column(u'courses_course', 'SEO_description')
