...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Partner.money_spent'
        db.add_column(u'courses_partner', 'money_spent',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Partner.money_spent'
        db.delete_column(u'courses_partner', 'money_spent')
