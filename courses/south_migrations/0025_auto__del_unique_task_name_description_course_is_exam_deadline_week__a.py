...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Task', fields ['name', 'description', 'course', 'is_exam', 'deadline', 'week']
        db.delete_unique(u'courses_task', ['name', 'description', 'course_id', 'is_exam', 'deadline', 'week'])

        # Adding unique constraint on 'Task', fields ['name', 'description', 'course', 'is_exam', 'week']
        db.create_unique(u'courses_task', ['name', 'description', 'course_id', 'is_exam', 'week'])


    def backwards(self, orm):
        # Removing unique constraint on 'Task', fields ['name', 'description', 'course', 'is_exam', 'week']
        db.delete_unique(u'courses_task', ['name', 'description', 'course_id', 'is_exam', 'week'])

        # Adding unique constraint on 'Task', fields ['name', 'description', 'course', 'is_exam', 'deadline', 'week']
        db.create_unique(u'courses_task', ['name', 'description', 'course_id', 'is_exam', 'deadline', 'week'])
    ...
    models = {
        ...
        u'courses.task': {
            'Meta': {'unique_together': "(('name', 'description', 'course', 'is_exam', 'week'),)", 'object_name': 'Task'},
