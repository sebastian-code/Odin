...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Task', fields ['name', 'description']
        db.create_unique(u'courses_task', ['name', 'description'])


    def backwards(self, orm):
        # Removing unique constraint on 'Task', fields ['name', 'description']
        db.delete_unique(u'courses_task', ['name', 'description'])
    ...
    models = {
        ...
        u'students.user': {
            ...
            'avatar': (u'django_resized.forms.ResizedImageField', [], {'max_length': '100', 'max_width': '200', 'blank': 'True'}),
