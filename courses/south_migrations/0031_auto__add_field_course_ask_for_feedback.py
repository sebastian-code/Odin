...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.ask_for_feedback'
        db.add_column(u'courses_course', 'ask_for_feedback',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.ask_for_feedback'
        db.delete_column(u'courses_course', 'ask_for_feedback')
