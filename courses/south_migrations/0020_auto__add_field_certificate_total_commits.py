...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Certificate.total_commits'
        db.add_column(u'courses_certificate', 'total_commits',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Certificate.total_commits'
        db.delete_column(u'courses_certificate', 'total_commits')
